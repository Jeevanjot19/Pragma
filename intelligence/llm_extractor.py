...
# ============================================================================
# Single Groq API Setup (No Failover)
# ============================================================================
# Using only primary API to avoid 2x request rate from failover retries
# This prevents hitting TPM (tokens per minute) limits faster
